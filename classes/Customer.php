...
class Customer
{
    ...
    public function customerRegistration($data)
    {
        ...
        if ($name == "" || $address == "" || $city == "" || $email == "" || $country == "" || $phone == "" || $pass == "") {
        ...
        if ($mailchk != false) {
            ...
            $query = "INSERT INTO tbl_customers(name, address, city, country, phone, email, pass) VALUES('$name', '$address', '$city', '$country', '$phone', '$email', '$pass')";
    ...
    public function customerUpdate($data, $cmrId)
    {
        ...
        if ($name == "" || $address == "" || $city == "" || $email == "" || $country == "" || $phone == "") {
            $msg = "<span class='error'>Fields must not be empty!</span>";
            return $msg;
        } else {
